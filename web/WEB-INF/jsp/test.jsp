            ...
            <form ng-submit="ctrl.submit()" name="myForm" class="form-horizontal">
                    ...
                    <div class="form-group col-md-12">
                        ...
                        <div class="col-md-7">
                            <input type="text" ng-model="ctrl.mail.headTemplate" name="mhead"
                                   class="mailhead form-control input-sm" placeholder="Enter mail2 header" required
                                   ng-minlength="3"/>
                ...
                <div class="row">
                    <div class="form-group col-md-12">
                        ...
                        <div class="col-md-7">
                            <input type="text" ng-model="ctrl.mail.bodyTemplate" class="form-control input-sm"
                ...
                <div class="row">
                    <div class="form-actions floatRight">
                        <input type="submit" value="{{!ctrl.mail.id ? 'Add' : 'Update'}}" class="btn btn-primary btn-sm"
        ...
        <div class="tablecontainer">
            <table class="table table-hover">
                ...
                <tr ng-repeat="m in ctrl.mails">
                    ...
                    <td>
                        <button type="button" ng-click="ctrl.edit(m.id)" class="btn btn-success custom-width">Edit
                        </button>
                        <button type="button" ng-click="ctrl.remove(m.id)" class="btn btn-danger custom-width">Remove
                        </button>
                    </td>
                </tr>
                </tbody>
